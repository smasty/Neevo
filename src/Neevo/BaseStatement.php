...
abstract class BaseStatement implements ObservableInterface
{
    ...
    public function __call($name, $args)
    {
        ...
        if (in_array($name, array('and', 'or'))) {  // AND/OR where() glues
            ...
            return $this;
        } elseif (in_array($name, array('if', 'else', 'end'))) {  // Conditional statements
    ...
    public function run()
    {
        ...
        $this->notifyObservers(isset($this->type) ? self::$eventTable[$this->type] : ObserverInterface::QUERY);
