...
class ConnectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetDriverNoFile()
    {
        ...
        new Connection(array('driver' => 'Foo'));
    }
    ...
    public function testSetDriverNoDriver()
    {
        ...
        new Connection(array('driver' => 'Wrong'));
    }
    ...
    {
        $this->instance->attachObserver($o = new Mocks\DummyObserver, Mocks\DummyObserver::DISCONNECT);
